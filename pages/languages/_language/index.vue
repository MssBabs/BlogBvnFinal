<template>
  <b-container>
    ...
    <main class="py-lg-4">
      ...
      <div class="row mb-2">
        <LanguagePreview :posts="posts" :paginatedFetch="paginatedFetch"/>
...
import LanguagePreview  from "../../../components/viewsComponents/LanguagePreview.vue"
  ...
  methods:{
    async paginatedFetch(page){
      const query = {
        query: {
          type: 'posts',
        "metadata.category":{$in:["languages"]},
        "metadata.languages":{$in:[this.$route.params.language]}
        },
        limit: 12,
        skip: page*12, 
        sort: "-created_at",
